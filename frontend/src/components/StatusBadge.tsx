...
const config: Record<string, { label: string; dot: string; className: string; pulse?: boolean }> = {
  ...
  pending:     { label: 'Pending',     dot: 'bg-amber-500',   className: 'bg-amber-50 text-amber-700 border-amber-200', pulse: true },
  starting:    { label: 'Starting',    dot: 'bg-emerald-400', className: 'bg-emerald-50 text-emerald-700 border-emerald-200', pulse: true },
  stopping:    { label: 'Stopping',    dot: 'bg-amber-500',   className: 'bg-amber-50 text-amber-700 border-amber-200', pulse: true },
  terminating: { label: 'Terminating', dot: 'bg-red-400',     className: 'bg-red-50 text-red-600 border-red-200', pulse: true },
  ...
  building:    { label: 'Building',    dot: 'bg-amber-500',   className: 'bg-amber-50 text-amber-700 border-amber-200', pulse: true },
